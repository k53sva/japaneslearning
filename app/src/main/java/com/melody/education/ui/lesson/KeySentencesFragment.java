 ...
 */
public class KeySentencesFragment extends Fragment {
    public static final String EXTRA_INDEX = "EXTRA_INDEX";
    private String ChungID;
    private LessonKeySentencesAdapter adapter;

    public static KeySentencesFragment newInstance(String index) {
        KeySentencesFragment fragment = new KeySentencesFragment();
    ...
    private void initView(View v) {
        adapter = new LessonKeySentencesAdapter(getActivity(), new ArrayList<>());
